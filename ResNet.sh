...
#SBATCH --job-name=ResNet         # Specify job name
...
# srun caffe train -solver data/DE.24/32x32/ResNet.cape_solver.prototxt

srun caffe train -solver data/DE.24/32x32/ResNet.CatRaRE_solver.prototxt -snapshot data/DE.24/32x32/ResNet.cape_iter_5000.solverstate
