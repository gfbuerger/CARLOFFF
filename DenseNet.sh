...
#SBATCH --job-name=DenseNet         # Specify job name
...
# srun caffe train -solver data/DE.24/32x32/DenseNet.cape_solver.prototxt

srun caffe train -solver data/DE.24/32x32/DenseNet.CatRaRE_solver.prototxt -snapshot data/DE.24/32x32/DenseNet.CatRaRE_iter_30000.solverstate
