function [model, time, ensembleResults] = m5pbuild_new(Xtr, Ytr, trainParams, ...
...
%
% Call:
%   [model, time, ensembleResults] = m5pbuild_new(Xtr, Ytr, trainParams, ...
%       isBinCat, trainParamsEnsemble, keepNodeInfo, verbose)
%
...
%
% Copyright (C) 2010-2020  Gints Jekabsons
%
...
% toolbox for Matlab/Octave, ver. 1.8.0, 2020, available at http://www.cs.rtu.lv/jekabsons/
...
if isempty(trainParamsEnsemble)
	...
	model = models ;
        ...
        for t = 1 : trainParamsEnsemble.numTrees
            ...
            modelNew = model;
            modelNew = buildTree(modelNew, Xtr, Ytr, sd, numNotMissing, binCatNewNum, beta, ...
