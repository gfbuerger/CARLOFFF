function [Yq, contrib] = m5ppredict_new(model, Xq)
% m5ppredict_new
...
%
% Call:
%   [Yq, contrib] = m5ppredict_new(model, Xq)
%
% Input:
...
%                   Kuzmin et al., 2011; Palczewska et al., 2013). See
...
if numModels == 1
    ...
    if (nargout > 1)
        ...
        for j = 1 : numModels
            for i = 1 : nq
                Yq(i,j) = predictsingle(models{j}, Xq(i,:));
            end
        end
    end
end
